			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zuicostcnfg-display": {
								"semanticObject": "zuicostcnfg",
								"action": "display",
								"description": "Costing Configuration",
								"title": "App Title",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zuicostcnfg",
									"url": sap.ui.require.toUrl("zuicostcnfg")
								}
							}
						}
					}
