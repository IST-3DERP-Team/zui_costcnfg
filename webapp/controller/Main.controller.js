        ...
        return Controller.extend("zuicostcnfg.controller.Main", {
            ...
            onInit: function () {
                ...
                this._oTableLayout = {
                    headerTab: {
                        type: "COSTCNFGHDR",
                        tabname: "ZERP_CSCONFIG"
                    },
                    detailTab: {
                        type: "COSTCNFGDTL",
                        tabname: "ZERP_CSCONFVAR"
                    }
                }
            ...
            //     oDDText = await this.getAddtlCaptionMsgs(this, oDDTextParam);
            ...
            // getAddtlCaptionMsgs: async (me, oDDTextParam) => {
